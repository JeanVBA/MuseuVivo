...
exhibition_work_of_art_bp.route('/exhibition/<int:id>', methods=['GET'])(get_by_exhibition_id)
exhibition_work_of_art_bp.route('/work_of_art/<int:id>', methods=['GET'])(get_by_work_of_art_id)
